...
public class MessageRepository {
    ...
    public void createTable() {
        ...
        StringBuilder sb = new StringBuilder("CREATE TABLE IF NOT EXISTS ").append(TABLE_NAME).append("(").append("id int PRIMARY KEY, ").append("message text);");
...
//
//        StringBuilder sb = new StringBuilder("CREATE TABLE IF NOT EXISTS ").append(TABLE_NAME_BY_TITLE).append("(").append("id int, ").append("title text,").append("PRIMARY KEY (title, id));");
//
//
//
//        final String query = sb.toString();
...
//    }
    ...
    public void insertbook(Messages book) {

    	 StringBuilder sb = new StringBuilder("INSERT INTO ").append(TABLE_NAME).append("(id,message) ").append("VALUES (").append(book.getId()).append(", '").append(book.getMessage()).append("');");
...
//
//        StringBuilder sb = new StringBuilder("SELECT * FROM ").append(TABLE_NAME).append(" WHERE title = '").append(title).append("';");
//
//
//
//        final String query = sb.toString();
...
//        for (Row r : rs) {
//
//            Book s = new Book(r.getint("id"), r.getString("title"), null, null);
//
//            books.add(s);
//
//        }
...
//
    ...
    public List<Messages> selectAll() {
        ...
        List<Messages> books = new ArrayList<Messages>();



        for (Row r : rs) {

            Messages book = new Messages(r.getInt("id") , r.getString("message"));
...
//        for (Row r : rs) {
//
//            Book book = new Book(r.getint("id"), r.getString("title"), null, null);
//
//            books.add(book);
//
//        }
